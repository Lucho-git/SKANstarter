...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$navigating ? ` <div class="fixed w-full top-0 right-0 left-0 h-1 z-50 bg-primary"></div>` : ``} ${slots.default ? slots.default({}) : ``} ${validate_component(SvelteToast, "SvelteToast").$$render($$result, { options }, {}, {})}`;
});
export {
  Layout as default
};
