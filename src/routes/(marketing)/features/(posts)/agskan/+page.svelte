<div class="space-y-8">
  ...
  <div class="bg-blue-100 p-6 rounded-lg shadow-md">
    ...
    <p class="text-lg text-gray-700 mb-4">
      See where your team is at all times. Track each operator's location on an
      interactive map with custom vehicle icons and colors. This helps
      coordinate work and keeps everyone safe.
    </p>
  </div>

  <div class="bg-green-100 p-6 rounded-lg shadow-md">
    <h2 class="text-3xl font-bold mb-4 text-green-800 mt-0">Feature Marking</h2>
    <p class="text-lg text-gray-700 mb-4">
      Easily mark features, landmarks, and obstacles. Press and hold on the map
      to choose icons for rocks, stumps, water tanks, and more. Or use the quick
      button to mark your current spot. Never miss an important point on your
      land.
    </p>
  </div>
  ...
  <div class="bg-yellow-100 p-6 rounded-lg shadow-md">
    ...
    <p class="text-lg text-gray-700 mb-4">
      ...
      a quick overview of all the work happening on your farm at any time.
    </p>
  </div>
</div>
