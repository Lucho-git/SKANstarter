...
<div class="bg-muted/50">
  ...
  <footer class="container p-8 md:p-16">
    <div
      class="flex flex-col justify-center gap-8 md:flex-row md:gap-x-48 lg:gap-x-64 xl:gap-x-96"
    >
      ...
      <aside class="flex flex-col items-center justify-center">
        <div class="flex gap-6">
          <a
            ...
            class="transition duration-300 ease-in-out hover:scale-110 hover:text-primary"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
        ...
        <!-- Links -->
        <nav class="mt-4 flex flex-wrap justify-center gap-4">
          <a
